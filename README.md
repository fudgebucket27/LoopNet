...
### LoopNetConsole
LoopNetConsole is a console application that you can use to play around with the methods from LoopNet. See [here](https://github.com/fudgebucket27/LoopNet/edit/master/README.md#running-loopnetconsoleloopnettests) for setup.
